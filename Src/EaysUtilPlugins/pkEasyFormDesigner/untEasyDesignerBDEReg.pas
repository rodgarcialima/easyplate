unit untEasyDesignerBDEReg;

{
引入环境变量
D:\Program Files\Borland\Delphi7\Lib\Delphi2
}
interface
...
begin
  ...
  begin
    ...
    RegisterComponents('Easy BDE', [TTable, TQuery, TStoredProc, TDatabase,
      TSession, TBatchMove, TUpdateSQL]);

    { Components that are excluded from the STD & PRO SKUs }
    if GDAL = 0 then
      RegisterComponents('Easy BDE', [TNestedTable]);
