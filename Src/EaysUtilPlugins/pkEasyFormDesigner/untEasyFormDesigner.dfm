object frmEasyFormDesigner: TfrmEasyFormDesigner
  ...
  object ImageList1: TImageList
    ...
    Bitmap = {
      ...
      
  ...
  object ActionList1: TActionList
    ...
    object ecClear1: TecClear
      Category = 'EC Editor'
      Caption = '&Clear'
      Hint = 'Clear|Clear current selection'
      ImageIndex = 25
      ShortCut = 16430
    end
    ...
    object ecRedo1: TecRedo
      Category = 'EC Editor'
      Caption = '&Redo'
      Hint = 'Redo|Perform redo if available'
      ImageIndex = 27
      ShortCut = 24666
    end
    ...
    object ecIndent1: TecIndent
      Category = 'EC Editor'
      Caption = '&Indent'
      Hint = 'Indent|Indent selection'
      ImageIndex = 28
      ShortCut = 16393
    end
    object ecUnindent1: TecUnindent
      Category = 'EC Editor'
      Caption = '&Unindent'
      Hint = 'Unindent|Unindent selection'
      ImageIndex = 29
      ShortCut = 8201
    end
    object ecLowerCase1: TecLowerCase
      Category = 'EC Editor'
      Caption = 'Selection Lower Case'
      Hint = 
        'Selection Lower Case|Lower case to current selection or current ' +
        'char'
      ShortCut = 16459
    end
    object ecUpperCase1: TecUpperCase
      Category = 'EC Editor'
      Caption = 'Selection Upper Case'
      Hint = 
        'Selection Upper Case|Upper case to current selection or current ' +
        'char'
      ShortCut = 16459
    end
    object ecToggleCase1: TecToggleCase
      Category = 'EC Editor'
      Caption = 'Selection Toggle Case'
      Hint = 
        'Selection Toggle Case|Toggle case to current selection or curren' +
        't char'
    end
    object ecSyntMemoAction1: TecSyntMemoAction
      Category = 'EC Editor'
      Caption = 'ecSyntMemoAction1'
    end
  end
