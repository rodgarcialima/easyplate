unit untEasyDesignerDataSourceReg;
...
procedure DesignerDataSourceRegister;
...
begin
  ...
  begin
    RegisterComponents('Easy dbGo', [TDataSource]);

{$IFDEF LINUX}
    RegisterComponents('Easy dbGo', [TLocalConnection]);
{$ENDIF}
