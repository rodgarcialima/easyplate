...
uses
  ...
  untEasyUtilRWIni in '..\util\pkEasyUtilRWConfig\untEasyUtilRWIni.pas',
  untEasyUtilStream in '..\util\pkEasyUtilRWConfig\untEasyUtilStream.pas';
...
begin
 { if not Installing then
  ...
  Application.CreateForm(TfrmEasyPlateServerMain, frmEasyPlateServerMain);
  Application.Run;
end.
