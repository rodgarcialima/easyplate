  ...
  begin   
      ...
      begin   
          ...
          if   GetLeapMonth(iLY)   =   iLM   then   
              stbStatusBar.Panels[1].Text:=   '农历   '   +   FormatLunarYear(iLY)   +   '闰'   +   FormatMonth(iLM)   +   FormatLunarDay(iLD)   +   GetLunarHolDay(Now)   
          else   
              stbStatusBar.Panels[1].Text:=   '农历   '   +   FormatLunarYear(iLY)   +   FormatMonth(iLM)   +   FormatLunarDay(iLD)   +   GetLunarHolDay(Now);   
      end;   
  end;   
}
