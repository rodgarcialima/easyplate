unit untEasyDesignerExtEditReg;
...
procedure DesignerExtEditRegister;
...
{$ENDIF}  
  ...
  RegisterComponents('Easy Standard', [TcxLabel, TcxProgressBar, TcxTrackBar,
    TcxCheckListBox, TcxColorComboBox, TcxFontNameComboBox, TcxCheckComboBox,
    TcxCheckGroup, TcxRichEdit]);
  RegisterComponents('Easy DB', [TcxDBLabel, TcxDBProgressBar, TcxDBTrackBar,
    TcxDBCheckListBox, TcxDBColorComboBox, TcxDBFontNameComboBox, TcxDBCheckComboBox,
    TcxDBCheckGroup, TcxDBRichEdit]);
  RegisterComponents('Easy Utilities', [TcxHintStyleController, TcxSpinButton,
